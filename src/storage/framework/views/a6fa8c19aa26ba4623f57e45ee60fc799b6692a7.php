...
<head>
    ...
    <title>会员登录 - <?php echo e(config('sys.web.name','二级域名分发')); ?></title>
        ...
        methods: {
            ...
            login: function () {
                ...
                this.$post('/login', $("#form-login").serialize())
                    .then(function (data) {
                        if (data.status === 0) {
                            location.href = data.go ? data.go : "<?php echo e(request()->get('go','/')); ?>";
                        } else {
                            layer.alert(data.message);
                        }
                    });
...
</html><?php /**PATH /home/ftp/s/s3964999/wwwroot/src/resources/views/login.blade.php ENDPATH**/ ?>