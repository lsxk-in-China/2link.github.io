...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - 管理后台 - <?php echo e(config('app.name')); ?></title>
        ...
        <ul class="navbar-nav bd-navbar-nav flex-row">
            ...
            <li class="nav-item">
                <a class="nav-link nav-logo-name d-none d-sm-block" href="/"><i class="fa fa-cloud"></i> 快乐二级域名分发系统
                    V<?php echo e(config('version')); ?> 蓝星美化版</a>
    ...
    <ul class="navbar-nav flex-row ml-auto d-md-flex">
        <li class="nav-item dropdown">
            <a class="nav-item nav-link dropdown-toggle" href="#" id="user_btns"
               data-toggle="dropdown"><?php echo e(auth('admin')->user()->username); ?></a>
...
</html><?php /**PATH /home/ftp/s/s3964999/wwwroot/src/resources/views/admin/layout/index.blade.php ENDPATH**/ ?>