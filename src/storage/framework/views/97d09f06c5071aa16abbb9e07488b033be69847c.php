                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="web[name]" class="form-control" placeholder="输入站点名称"
                                       value="<?php echo e(config('sys.web.name')); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="web[title]" class="form-control" placeholder="输入首页标题"
                                       value="<?php echo e(config('sys.web.title')); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="web[keywords]" class="form-control" placeholder="输入网站关键词"
                                       value="<?php echo e(config('sys.web.keywords')); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                ><?php echo e(config('sys.web.description')); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                ><?php echo config('sys.html_header'); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                ><?php echo config('sys.html_home'); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                ><?php echo config('sys.index_urls'); ?></textarea>
                ...
                <div class="card-body">
                    <form id="form-user">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="user[reg]" :value="<?php echo e(config('sys.user.reg',0)); ?>" class="form-control">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="user[email]" :value="<?php echo e(config('sys.user.email',0)); ?>"
                                        class="form-control">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="user[point]" class="form-control" placeholder="输入注册赠送积分"
                                       value="<?php echo e(config('sys.user.point',0)); ?>">
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="mail[host]" class="form-control" placeholder="SMTP服务器地址"
                                       value="<?php echo e(config('sys.mail.host','smtp.qq.com')); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="mail[port]" class="form-control" placeholder="SMTP服务器端口"
                                       value="<?php echo e(config('sys.mail.port','465')); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-3 col-form-label">加密类型</label>
                            <div class="col-sm-9">
                                <select name="mail[encryption]" :value="'<?php echo e(config('sys.mail.encryption','ssl')); ?>'"
                                        class="form-control">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="mail[username]" class="form-control" placeholder="邮箱账号"
                                       value="<?php echo e(config('sys.mail.username')); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="mail[password]" class="form-control" placeholder="邮箱密码"
                                       value="<?php echo e(config('sys.mail.password')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="mail[test]" class="form-control" placeholder="输入一个邮箱地址"
                                       value="<?php echo e(config('sys.mail.test','123456@qq.com')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="reserve_domain_name" placeholder="输入你想保留的域名前缀"
                                          rows="3"
                                ><?php echo e(config('sys.reserve_domain_name')); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ftp/s/s3964999/wwwroot/src/resources/views/admin/config/sys.blade.php ENDPATH**/ ?>