                    ...
                    <div class="form-group">
                        <select class="form-control" v-model="search.gid">
                            ...
                            <?php $__currentLoopData = \App\Models\UserGroup::where('gid','!=',99)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($group->gid); ?>"><?php echo e($group->name); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ftp/s/s3964999/wwwroot/src/resources/views/admin/user/list.blade.php ENDPATH**/ ?>