...
<head>
    ...
    <title>程序安装 - <?php echo e(config('app.name')); ?></title>
    ...
    <div class="col-12 col-md-4 offset-md-4 mt-3 mt-sm-5">
        ...
        <?php else: ?>
            <div class="card mb-3" v-if="step===1">
                ...
                <div class="card-body">
                    <?php if($check=true): ?><?php endif; ?>
                    <?php $__currentLoopData = $support; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!$row['support'] && $check=false): ?><?php endif; ?>
                        <div class="list-group-item <?php echo e($row['support']?'text-success':'text-danger'); ?>">
                            <?php echo e($row['name']); ?>

                            <span class="float-right">
                                <i class="fa <?php echo e($row['support']?'fa-check':'fa-window-close'); ?>"></i>
                            </span>
                        </div>
...
</html><?php /**PATH /home/ftp/s/s3964999/wwwroot/src/resources/views/install.blade.php ENDPATH**/ ?>